  ...
  def InitializeDb(self, skeleton=False):
    ...
    with self.app.app_context():
      ...
      if not skeleton:
        ...
        chicken_patty = Item(
            name="Chicken Patty", root=False, identical=True, price=1)
        beef_patty = Item(
            name="Beef Patty", root=False, identical=True, price=1)
        vegetarian_patty = Item(
            name="Vegetarian Patty", root=False, identical=True, price=1)
        ...
        tomato_sauce = Item(
            name="Tomato Sauce", root=False, identical=True, price=1)
        bbq_sauce = Item(name="BBQ Sauce", root=False, identical=True, price=1)
        cheddar_cheese = Item(
            name="Cheddar Cheese", root=False, identical=True, price=1)
        ...
        nuggets = Item(name="Nuggets", root=True, price=0)
        ...
        nuggets_3_pack = Item(
            name="3-pack Nuggets", root=False, identical=True, price=2)
        nuggets_6_pack = Item(
            name="6-pack Nuggets", root=False, identical=True, price=3)
        nuggets_12_pack = Item(
            name="12-pack Nuggets", root=False, identical=True, price=4)
        ...
        fries = Item(name="Fries", root=True, price=0)
        ...
        small_size = Item(
            name="Small Fries", root=False, identical=True, price=2)
        medium_size = Item(
            name="Medium Fries", root=False, identical=True, price=3)
        large_size = Item(
            name="Large Fries", root=False, identical=True, price=4)
        ...
        sauce = IngredientGroup(
            name="Sauce", max_item=3, min_item=1, max_option=3, min_option=0)
        ...
        small_coke = Item(
            name="Small Coke", root=False, identical=True, price=2)
        medium_coke = Item(
            name="Medium Coke", root=False, identical=True, price=3)
        large_coke = Item(
            name="Large Coke", root=False, identical=True, price=4)
